...
export default {
    ...
    deleteTask: (projectId, taskId) => {
        return axios.delete(`/api/task/delete/${projectId}/${taskId}`)
        .then(res => {
            return res.data;
        })
        .catch(err => {
    ...
    addAssignee: (projectId, taskId, user) => {
        return axios.put(`/api/task/add_assignee/${projectId}/${taskId}`, {
            id: user.id,
    ...
    removeAssignee: (projectId, taskId, userId) => {
        return axios.put(`/api/task/remove_assignee/${projectId}/${taskId}/${userId}`)
        .then(res => {
            return res.data;
        })
        .catch(err => {
