            ...
            <Row>
              ...
              <Col className="productDescriptionText">
                ...
                <p>
                  ...
                  critical update or task. Whether you're at your desk, on the
                  go, or simply away from your device, 3rd's notifications will
                  keep you informed and on track. With 3rd, you'll have the
                  information you need, right when you need it, so you can focus
          ...
          <Container className="productDescription">
            <Row>
              ...
              <Col className="productDescriptionText">
                ...
                <p>
                  3rd has the tools you need to streamline communication, assign
          ...
          <Container className="productDescription">
            <Row>
              ...
              <Col className="productDescriptionText">
                ...
                <p>
                  with 3rd's multi-device notifications. Our innovative system
                  keeps you informed and connected, no matter where you are.
                  Choose which notifications to receive via email, desktop, or
